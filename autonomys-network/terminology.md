...
Autonomys' product suite, including the [Auto SDK](../auto-suite/auto-sdk.md), [Auto Agents Framework](../auto-suite/auto-agents.md) and [Auto ID](../auto-suite/auto-id/) for developers, and [Space Acres](../auto-suite/spaceacres-cli/), [Auto Portal](https://github.com/autonomys/auto-portal), and the [Autonomys CLI](terminology.md#autonomys-cli) for [farmers](terminology.md#farmer) and [operators](terminology.md#operator).
